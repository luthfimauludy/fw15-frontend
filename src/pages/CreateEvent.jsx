            ...
            {({ handleChange, handleBlur, handleSubmit, values }) => {
              return (
                <form
                  ...
                  className="text-black bg-white min-w-[80%] min-h-[200px] rounded-xl p-10"
                >
                    ...
                    <div className="w-[481px]">
                      ...
                      <div>
                        <select
                          ...
                          onChange={handleChange}
                          value={values.cityId}
                          className="select select-bordered mb-8 min-w-full border-[#c1c5d0] rounded-xl font-normal"
                        >
